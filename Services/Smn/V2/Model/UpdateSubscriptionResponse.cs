...
namespace G42Cloud.SDK.Smn.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateSubscriptionResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateSubscriptionResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateSubscriptionResponse input)
        {
            if (input == null)
                return false;
