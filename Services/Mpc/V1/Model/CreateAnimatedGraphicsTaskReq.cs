...
namespace G42Cloud.SDK.Mpc.V1.Model
{
    ...
    public class CreateAnimatedGraphicsTaskReq 
    {
        ...
        public AnimatedGraphicsOutputParam OutputParam { get; set; }
        ...
        {
            return this.Equals(input as CreateAnimatedGraphicsTaskReq);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateAnimatedGraphicsTaskReq input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.OutputParam == input.OutputParam ||
                    (this.OutputParam != null &&
                    this.OutputParam.Equals(input.OutputParam))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.OutputParam != null)
                    hashCode = hashCode * 59 + this.OutputParam.GetHashCode();
                return hashCode;
            }
        }
    }
