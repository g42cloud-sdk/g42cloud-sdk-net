...
namespace G42Cloud.SDK.Mpc.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListTranscodingTaskResponse : SdkResponse
    {

        [JsonProperty("task_array", NullValueHandling = NullValueHandling.Ignore)]
        public List<QueryTranscodingsTaskResponse> TaskArray { get; set; }
        ...
        {
            return this.Equals(input as ListTranscodingTaskResponse);
        }
