...
namespace G42Cloud.SDK.Mpc.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListMergeChannelsTaskResponse : SdkResponse
    {

        [JsonProperty("task_array", NullValueHandling = NullValueHandling.Ignore)]
        public List<MergeChannelsTaskInfo> TaskArray { get; set; }
        ...
        {
            return this.Equals(input as ListMergeChannelsTaskResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListMergeChannelsTaskResponse input)
        {
            if (input == null)
                return false;
