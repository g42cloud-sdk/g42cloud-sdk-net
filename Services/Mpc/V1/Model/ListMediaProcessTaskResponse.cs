...
namespace G42Cloud.SDK.Mpc.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListMediaProcessTaskResponse : SdkResponse
    {

        [JsonProperty("task_array", NullValueHandling = NullValueHandling.Ignore)]
        public List<MediaProcessTaskInfo> TaskArray { get; set; }
        ...
        {
            return this.Equals(input as ListMediaProcessTaskResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListMediaProcessTaskResponse input)
        {
            if (input == null)
                return false;
